"""
Url shortener.
/           form to add a url to be shortened; optional field to come up with your own alias
            If alias is already in use, the user is offered to create a different alias.
            If no alias is provided, an alias is autogenerated.
            Redirects to the page displaying the full url and the alias that has just been recorded.
/stats      displays the most popular short url(s) and how frequently they have been accessed.
/stats/<url>    displays how many times this url has been accessed
/<short_url>    redirects to the full url, displays error if short_url is not found
"""
